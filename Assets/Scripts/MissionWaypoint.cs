...
public class MissionWaypoint : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.layer == LayerMask.NameToLayer("Sheep"))
        {
            ...
            RaycastHit[] hits = Physics.BoxCastAll(transform.position, Vector3.Scale(triggerCollider.size, transform.localScale) / 2f, Vector3.forward, Quaternion.identity, 0f, (1 << LayerMask.NameToLayer("Sheep")));
